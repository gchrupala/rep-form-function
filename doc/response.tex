...
We have substantially revised the article in response to yours and the reviewers' 
...
Section 6 into a single section (Section 4 in the revised manuscript) reporting all the 
...
to include relevant papers that came out while this manuscript was under review, and expanded the Discussion
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:} \todo[inline]{This needs explanation and I don't have an answer (yet).}
\end{quote}
\begin{verbatim}

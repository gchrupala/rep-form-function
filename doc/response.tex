...
\todo[inline]{explain the major revisions}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{this figure should be removed.}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:} probably reorganise this section \todo[inline]{explain changes}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{add to related work}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{explain reorganisations and major changes.}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{explain restructuring of section 6}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{this section should probably be removed}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{explain}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{good point! what is the value of lambda?}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{Grzegorz?}
\end{quote}
\begin{verbatim}
- specify interaction features in regression model
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{specify interaction features}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{discuss linzen et al. in related work}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{explain new experiments}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{hmm.}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{explain the rewritten version.}
\end{quote}
\begin{verbatim}
...
\end{verbatim}  
\begin{quote}
\textsc{Author Response:}  \todo[inline]{add this to related work.}
\end{quote}
\begin{verbatim}

\section{Analysis of hidden units}
\label{sec:micro}

%Using the $\mathrm{omission}$ score distributions over 
%POS categories and grammatical functions (deprels) 
%- described in Section~\ref{sec:categories} - t
%measure the relative contribution of tokens to the meaning sentences using
%RNN hidden activations. \ref{subsec:omitstruct}
%
%
%
%Section~\label{sec:omitsentiment} provided evidence for the vali demonstrated 
...
\centering
    ...
    %\begin{tabular}{|l|l|}
    \hline
    {\sc Visual} & {\sc Textual} %& {\sc Sentiment} 
    \\
    \hline
    ...
    other cars driving, engine car traveling, watches cars racing, with passengers driving 
     %enormously good fun, and beautifully crafted, funny and beautifully, touching smart and, smart and complicated 
     \\
    \hline
    ...
    %moving is funny, and always fun, is both funny, is funny and, s best actors
    \\
    \hline
...
%    a great fun, and unoriginal mess , and witless mess, is disjointed mess, movie best enjoyed
    \\
    \hline       
...
sitting next
    ...
    %& s best performance, the best performance, with wonderful performances, 
%career best performances, winner smart funny 
    \\
    \hline
    a dirt track, a race track, a stunt jump, stunt jump in, in the air 
    %through the waves, coming from their, surfing rough waves, rough waves on, as the surfer
    & on the shore, on the floor, at the end, at the shore, on the side
    %& America and Israel, in America and, both in America, period of history, entire 
    %period of 
    \\
    \hline
...
he plays &
   ...
   \hline
   %\multicolumn{2}{|c|}{\bf POS} \\
   % {\sc Textual} & {\sc Visual} \\
   %\hline

   %{\bf DT}: out onto a, top of a, water onto a, water on a    &
   %{\bf PRP}: riding on it, snow on it, snowboard riding it, cars on it, \\  
   %\hline

    %{\bf WP}:  standing in what, not sure what, checking out what, to eat what &
    %{\bf JJ}: clock and multiple, spire and decorative, black and whit, green and white\\
    %  \hline

    
    %{\bf VBG}: up and looking, teeth and looking, skinny cat looking, dog and looking 
%&
 %   {\bf CC}: a waterway and, a black and, some rocks and, with trees and\\
  %  \hline


   % {\bf RB}: people standing very, in a very, in a very, in a very &
   % {\bf CD}: pole in two, light with two, steeple and two, set between two\\
   %     \hline

   %{\bf PRP\$}: skier makes their, skier makes his, up over his, frisbee near his &
   %{\bf IN}: several bunches of, with lots of, the end of, has trays of\\   
  %\hline
...
We define $A^m_j$ as a  discrete random variable corresponding 
...
bootstrap distributions for \text{uni-,} bi-, and trigram contexts, in

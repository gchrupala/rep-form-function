...
different distribution. We next compare the models' score pairwise to
...
for uni-, bi-, and trigram contexts, in the word and deprel conditions. 
...
encoded by the hidden units of the models are indeed different, and

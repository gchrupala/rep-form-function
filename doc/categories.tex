...
\begin{enumerate}
	...
	\item {\sc LR deprel}: word type, dependency label and their interaction 
	\item {\sc LR position}: word type, position (binned as first, second, third, middle,
...
\caption{Proportion of variance in omission scores explained by the
 ...
 regressing on word identity only. }
\label{fig:rsquared}
\end{figure}
